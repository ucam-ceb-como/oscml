# The following lines were copied from ifg.py in https://github.com/rdkit/rdkit/tree/master/Contrib/IFG
...
PATT_DOUBLE_TRIPLE = rdkit.Chem.MolFromSmarts('A=,#[!#6]')
# atoms in non aromatic carbon-carbon double or triple bonds
PATT_CC_DOUBLE_TRIPLE = rdkit.Chem.MolFromSmarts('C=,#C')
...
PATT_ACETAL = rdkit.Chem.MolFromSmarts('[CX4](-[O,N,S])-[O,N,S]')
# all atoms in oxirane, aziridine and thiirane rings
PATT_OXIRANE_ETC = rdkit.Chem.MolFromSmarts('[O,N,S]1CC1')
